...
/**
 * 输入指定字符串转换为密文，不可逆，
 * 主要方法：getMD5ofStr(String string);
 * */
public class MD5Code {
	...
	public String getMD5ofStr(String s) {
		...
		md5Final();
		String digestHexStr = "";
	//	System.out.println("MD5 Test suite:" + digestHexStr);
		for (int i = 0; i < 16; i++)
	...
	public static void main(String args[]) {
		MD5Code a = new MD5Code();
		System.out.println("MD5 Test result:" + a.getMD5ofStr("1"));
		// MD5 md5 = new MD5();
		//       
		...
		// +
		// md5.getMD5ofStr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
		// } else
		// {
