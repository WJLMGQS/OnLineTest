...
public class Paper_status_order extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(showMessage==null){//数据检测通过后更新试卷中的数据信息
			...
			TestPaper testPaper = testPaperServiceImp.loadAdminTestPaperById(teacher, bulidId);
		...
		//转向显示所有试卷的页面
		response.sendRedirect(request.getContextPath()+"/teacher/admin/paper_list?status="+localTrack.getIndex());
	}
