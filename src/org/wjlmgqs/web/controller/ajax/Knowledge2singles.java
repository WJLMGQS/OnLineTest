...
public class Knowledge2singles extends HttpServlet {

	private static final long serialVersionUID = -2949285422708648435L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Map<String,List<Single>> map = new HashMap<String,List<Single>>();
		if (knowledgeId == null) {
		} else {
			try {
				...
				//返回所有记录
				singles = singleServiceImp.getAllSinglesByKnowledgeId(knowledge_id,(Teacher)request.getSession().getAttribute("professionTeacher"));
			} catch (NumberFormatException e) {
				WebLogger.showInfor("知识点编号错误");
				e.printStackTrace();
			}
		}
		map.put("aaData",singles);
