...
/**
 */
public class Paper_fillBlanks_add extends HttpServlet {
	...
	* */
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/teacher/profession/paper_fillBlanks_add.jsp").forward(request,response);
	}
