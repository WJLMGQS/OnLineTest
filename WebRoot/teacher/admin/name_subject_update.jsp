...
<html>
 ...
 <center>
 	<h1>科目信息更改</h1>
 	<a href="${pageContext.request.contextPath}/teacher/admin/name_subject">后退</a>
<hr/>
	<form id="infoForm" action="${pageContext.request.contextPath}/teacher/admin/name_subject_update_info?subjectId=${subject.id}" method="post">
		科目代码<input name="code" type="text" value="${subject.code}" reg="\S+" tip="不能为空！"/>
		<br/>
