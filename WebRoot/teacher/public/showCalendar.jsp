...
a:hover {
	...
	var monthName = new Array("一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月",
			"九月", "十月", "十一月", "十二月");

	//国历节日 *表示放假日
	var sFtv = new Array("0101*元旦节", "0202 世界湿地日", "0210 国际气象节", "0214 情人节",
			...
			"0323 世界气象日", "0324 世界防治结核病日", "0325 全国中小学生安全教育日", "0330 巴勒斯坦国土日",
			"0401 愚人节 全国爱国卫生运动月(四月) 税收宣传月(四月)", "0407 世界卫生日", "0422 世界地球日",
			"0423 世界图书和版权日", "0424 亚非新闻工作者日", "0501*劳动节", "0504 青年节",
			"0505 碘缺乏病防治日", "0508 世界红十字日", "0512 国际护士节", "0515 国际家庭日",
			"0517 国际电信日", "0518 国际博物馆日", "0520 全国学生营养日", "0523 国际牛奶日",
			"0531 世界无烟日", "0601 国际儿童节", "0605 世界环境保护日", "0606 全国爱眼日",
			"0617 防治荒漠化和干旱日", "0623 国际奥林匹克日", "0625 全国土地日", "0626 国际禁毒日",
			"0701 香港回归纪念日 中共诞辰 世界建筑日", "0702 国际体育记者日", "0707 抗日战争纪念日",
			"0711 世界人口日", "0730 非洲妇女日", "0801 建军节", "0808 中国男子节(爸爸节)",
			"0815 抗日战争胜利纪念", "0908 国际扫盲日 国际新闻工作者日", "0909 毛泽东逝世纪念",
			"0910 中国教师节", "0914 世界清洁地球日", "0916 国际臭氧层保护日", "0918 九·一八事变纪念日",
			"0920 国际爱牙日", "0927 世界旅游日", "0928 孔子诞辰", "1001*国庆节 世界音乐日 国际老人节",
			"1002*国庆节假日 国际和平与民主自由斗争日", "1003*国庆节假日", "1004 世界动物日", "1006 老人节",
			"1008 全国高血压日 世界视觉日", "1009 世界邮政日 万国邮联日", "1010 辛亥革命纪念日 世界精神卫生日",
			"1013 世界保健日 国际教师节", "1014 世界标准日", "1015 国际盲人节(白手杖节)", "1016 世界粮食日",
			"1017 世界消除贫困日", "1022 世界传统医药日", "1024 联合国日", "1031 世界勤俭日",
			"1107 十月社会主义革命纪念日", "1108 中国记者日", "1109 全国消防安全宣传教育日", "1110 世界青年节",
			"1111 国际科学与和平周(本日所属的一周)", "1112 孙中山诞辰纪念日", "1114 世界糖尿病日",
			"1117 国际大学生节 世界学生节", "1120*彝族年", "1121*彝族年 世界问候日 世界电视日",
			"1122*彝族年", "1129 国际声援巴勒斯坦人民国际日", "1201 世界艾滋病日", "1203 世界残疾人日",
			"1205 国际经济和社会发展志愿人员日", "1208 国际儿童电视日", "1209 世界足球日", "1210 世界人权日",
			"1212 西安事变纪念日", "1213 南京大屠杀(1937年)纪念日！谨记血泪史！", "1220 澳门回归纪念",
			"1221 国际篮球日", "1224 平安夜", "1225 圣诞节", "1226 毛泽东诞辰纪念")

	//农历节日 *表示放假日
	var lFtv = new Array("0101*春节", "0102*初二", "0115 元宵节", "0505*端午节",
			"0707 七夕情人节", "0715 中元节", "0815*中秋节", "0909 重阳节", "1208 腊八节",
			"1223 小年", "0100*除夕")

	//某月的第几个星期几
	var wFtv = new Array(
			"0150 世界麻风日", //一月的最后一个星期日（月倒数第一个星期日）
			"0520 国际母亲节", "0530 全国助残日", "0630 父亲节", "0730 被奴役国家周",
			"0932 国际和平日", "0940 国际聋人节 世界儿童日", "0950 世界海事日", "1011 国际住房日",
	...
	function Lunar(objDate) {
		...
		var offset = (Date.UTC(objDate.getFullYear(), objDate.getMonth(),
				objDate.getDate()) - Date.UTC(1900, 0, 31)) / 86400000;
	...
	function calendar(y, m) {
		...
		for ( var i = 0; i < this.length; i++) {
			...
			this[i] = new calElement(y, m + 1, i + 1,
					nStr1[(i + this.firstWeek) % 7], lY, lM, lD++, lL, cY, cM,
					cD);
		}
		...
		if (m == 2)
			this[20].solarFestival = this[20].solarFestival
					+ unescape('%20%u6D35%u8CE2%u751F%u65E5');
	...
	function easter(y) {
		...
		var dayEaster = new Date(l15.getTime() + 86400000
...
if (sObj.innerHTML != '') {
	...
	if (cld[d].solarTerms == '' && cld[d].solarFestival == ''
		...
		festival = '<TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 BGCOLOR="#CCFFCC"><TR><TD>'
				...
				+ cld[d].solarFestival
				+ ' '
				+ cld[d].lunarFestival + '</FONT></TD>' + '</TR></TABLE>';
...
.todyaColor {
	...
	<BODY leftMargin=0 topMargin=15 onload=initial()>
		...
		<CENTER>
					...
					<TBODY>
						<TR>
							<TD vAlign="top" align="middle">
								<BR>
								<FONT style="FONT-SIZE: 9pt">本机时间:</FONT>
								<BR>
								<FONT id=Clock face=Arial color=#000080 size=4 align="center"></FONT>
								<P>
									<!--时区 *表示自动调整为日光节约时间-->
									<FONT style="FONT-SIZE: 9pt" size=2> <SELECT
											style="FONT-SIZE: 9pt" onchange=changeTZ() name=TZ>
											<OPTION value="-1200 安尼威土克、瓜甲兰" selected>
												国际换日线</OPTION>
											<OPTION value="-1100 中途岛、萨摩亚群岛">
												萨摩亚</OPTION>
												<OPTION value="-1000 夏威夷">
													夏威夷
												</OPTION>
											<OPTION value=-0900*阿拉斯加>
												阿拉斯加</OPTION>
												<OPTION value=-0800*太平洋时间(美加)、提亚纳>
													太平洋</OPTION>
													<OPTION value=-0700*亚历桑那>
														美国山区</OPTION>
														<OPTION value=-0700*山区时间(美加)>
															美加山区</OPTION>
															<OPTION value=-0600*萨克其万(加拿大)>
																加拿大中部</OPTION>
																<OPTION value=-0600*墨西哥市、塔克西卡帕>
																	墨西哥</OPTION>
																	<OPTION value=-0600*中部时间(美加)>
																		美加中部</OPTION>
																		<OPTION value=-0500*波哥大、里玛>
																			南美洲太平洋</OPTION>
																			<OPTION value=-0500*东部时间(美加)>
																				美加东部</OPTION>
																				<OPTION value=-0500*印第安纳(东部)>
																					美东</OPTION>
																					<OPTION value=-0400*加拉卡斯、拉帕兹>
																						南美洲西部</OPTION>
																						<OPTION value="-0400*大西洋时间 加拿大)">
																							大西洋</OPTION>
																							<OPTION value="-0330 新岛(加拿大东岸)">
																								纽芬兰</OPTION>
																								<OPTION value="-0300 波西尼亚">
																									东南美洲</OPTION>
																									<OPTION value="-0300 布鲁诺斯爱丽斯、乔治城">
																										南美洲东部</OPTION>
																										<OPTION value=-0200*大西洋中部>
																											大西洋中部</OPTION>
																											<OPTION value=-0100*亚速尔群岛、维德角群岛>
																												亚速尔</OPTION>
																												<OPTION value="+0000 格林威治时间、都柏林、爱丁堡、伦敦">
																													英国夏令</OPTION>
																													<OPTION value="+0000 莫洛维亚(赖比瑞亚)、卡萨布兰卡">
																														格林威治标准</OPTION>
																														<OPTION value="+0100 巴黎、马德里">
																															罗马</OPTION>
																															<OPTION value="+0100 布拉格, 华沙, 布达佩斯">
																																中欧</OPTION>
																																<OPTION
																																	value="+0100 柏林、斯德哥尔摩、罗马、伯恩、布鲁赛尔、维也纳">
																																	西欧</OPTION>
																																	<OPTION value="+0200 以色列">
																																		以色列</OPTION>
																																		<OPTION value=+0200*东欧>
																																			东欧</OPTION>
																																			<OPTION value=+0200*开罗>
																																				埃及</OPTION>
																																				<OPTION value=+0200*雅典、赫尔辛基、伊斯坦堡>
																																					GFT</OPTION>
																																					<OPTION value=+0200*赫拉雷、皮托里>
																																						南非</OPTION>
																																						<OPTION
																																							value=+0300*巴格达、科威特、奈洛比(肯亚)、里雅德(沙乌地)>
																																							沙乌地阿拉伯</OPTION>
																																							<OPTION
																																								value=+0300*莫斯科、圣彼得堡、贺占、窝瓦格瑞德>
																																								俄罗斯</OPTION>
																																								<OPTION value=+0330*德黑兰>
																																									伊朗</OPTION>
																																									<OPTION
																																										value=+0400*阿布达比(东阿拉伯)、莫斯凯、塔布理斯(乔治亚共和)>
																																										阿拉伯</OPTION>
																																										<OPTION value=+0430*喀布尔>
																																											阿富汗</OPTION>
																																											<OPTION
																																												value="+0500 伊斯兰马巴德、克洛奇、伊卡特林堡、塔须肯">
																																												西亚</OPTION>
																																												<OPTION
																																													value="+0530 孟买、加尔各答、马垂斯、新德里、可伦坡">
																																													印度</OPTION>
																																													<OPTION
																																														value="+0600 阿马提、达卡">
																																														中亚</OPTION>
																																														<OPTION
																																															...
																																															曼谷</OPTION>
																																															<OPTION
																																																value="+0800 北京、重庆、黑龙江">
																																																中国</OPTION>
																																																<OPTION
																																																	value="+0900 东京、大阪、扎幌、汉城、亚库兹(东西伯利亚)">
																																																	东京</OPTION>
																																																	<OPTION
																																																		value="+0930 达尔文">
																																																		澳洲中部</OPTION>
																																																		<OPTION
																																																			value="+1000 布里斯本、墨尔本、席德尼">
																																																			席德尼</OPTION>
																																																			<OPTION
																																																				value="+1000 霍巴特">
																																																				塔斯梅尼亚</OPTION>
																																																				<OPTION
																																																					value="+1000 关岛、莫斯比港、海  威">
																																																					西太平洋</OPTION>
																																																					<OPTION
																																																						value=+1100*马哥大、所罗门群岛、新卡伦多尼亚>
																																																						太平洋中部</OPTION>
																																																						<OPTION
																																																							value="+1200 威灵顿、奥克兰">
																																																							纽西兰</OPTION>
																																																							<OPTION
																																																								value="+1200 斐济、肯加塔、马歇尔群岛">
																																																								斐济</OPTION>
										</SELECT>时间 </FONT>
									<BR>
									<FONT id=Clock2 face=Arial color=#000080 size=4 align="center"></FONT>
									<BR>
									<FONT
										style="FONT-SIZE: 120pt; COLOR: green; FONT-FAMILY: Webdings">&ucirc;</FONT>
									<BR>
									<FONT id=CITY
										style="FONT-SIZE: 9pt; WIDTH: 150px; COLOR: blue; FONT-FAMILY: '新细明体'"></FONT>
								</P>
							</TD>
							<TD align=middle>
									...
									<TBODY>
										<TR>
											<TD bgColor=#000080 colSpan=7>
												<FONT style="FONT-SIZE: 9pt" color=#ffffff size=2>公历<SELECT
            ...
            //--></SCRIPT>
													</SELECT>月 </FONT><FONT id=GZ face=标楷体 color=yellow size=3></FONT>
												<BR>
											</TD>
										</TR>
			...
			<FONT face=ARIAL >阳历中</FONT><FONT color=red>红色</FONT>/<FONT color=green>绿色</FONT><FONT color=black>表示节假日，农历中</FONT><FONT color=green>绿色</FONT>表示为24节气日，<FONT color=red>红色</FONT>表示为传统节日，<FONT color=blue>蓝色</FONT>则表示为公众节假日<BR>
		</CENTER>
	</BODY>
</HTML>
