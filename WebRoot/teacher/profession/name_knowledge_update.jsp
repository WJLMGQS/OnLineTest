...
<html>
 ...
 <center>
 	<h1>知识点信息更改</h1>
 	<a href="${pageContext.request.contextPath}/teacher/profession/name_knowledge">后退</a>
<hr/>
	<form id="infoForm" action="${pageContext.request.contextPath}/teacher/profession/name_knowledge_update_info?knowledgeId=${knowledge.id}" method="post">
		知识点代码<input name="code" type="text" value="${knowledge.code}" reg="\S+" tip="不能为空！"/>
		<br/>
