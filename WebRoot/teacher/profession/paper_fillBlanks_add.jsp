...
<html>
  ...
  <body onload="initFillBlanksTableByAjax(0)">
	<select id="knowledgeId" size="1" onchange="initFillBlanksTableByAjax(this.value);">
	...
	<a href="###" id="checkReset">重置</a>	&nbsp;&nbsp;	<a href='${pageContext.request.contextPath}/teacher/profession/paper_fillBlanks_insert?' id="checkInsert">插入到试卷</a>	<br/>
	...
	<div class="defineTop" >
		...
		<div class="defineBase">
			...
			<table id="fillBlankTable" border='1' width='480px' style="text-align:center">
			</table>
