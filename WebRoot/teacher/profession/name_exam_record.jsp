...
<center>
	...
	<table cellpadding="5" cellspacing="0" border="1" class="display" id="eachRow" style="text-align:center;">
		<thead>
			<tr><th>名称</th><th>描述</th><th>科目</th><th>总时间</th><th>总分</th><th>结束日期</th><th>成绩统计</th></tr>
		</thead>
		<tbody>
			<c:forEach items="${allExamRecords}" var="examRecord" varStatus="status" step="1" >
				<tr title="描述：${examRecord.description}">
					...
					<td><a href="${pageContext.request.contextPath}/teacher/profession/mark_list?recordId=${examRecord.id}" target="_blank">导出成绩</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
