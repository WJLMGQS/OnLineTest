...
<html>
  ...
  <%--设置窗体右边显示界面的基本样式--%>  
	...
	<%-- 图片放大显示插件--%>
 	...
 	<%-- 处理试题插入和表格显示的函数定义--%>
 	<script type="text/javascript" src="${pageContext.request.contextPath}/js/dealJudgeView.js"></script>
	<%-- 显示试题的显示样式--%>
	<link href="${pageContext.request.contextPath}/css/style_question.css" rel="stylesheet" type="text/css"  />
  </head>
  <body onload="initJudgesTableByAjax(0)">
	<select id="knowledgeId" size="1" onchange="initJudgesTableByAjax(this.value);">
	...
	<a href="###" id="checkReset">重置</a>	&nbsp;&nbsp;	<a href='${pageContext.request.contextPath}/teacher/profession/paper_judges_insert?' id="checkInsert">插入到试卷</a>	<br/>
