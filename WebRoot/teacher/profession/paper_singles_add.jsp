...
<html>
  ...
  <body onload="initSinglesTableByAjax(0)">
	<select id="knowledgeId" size="1" onchange="initSinglesTableByAjax(this.value);">
	...
	<a href="###" id="checkReset">重置</a>	&nbsp;&nbsp;	<a href='${pageContext.request.contextPath}/teacher/profession/paper_singles_insert?' id="checkInsert">插入到试卷</a>	<br/>
	...
	<div id="showSingleItem" class="defineTop" >
		...
		<div class="defineBase">
			...
			<div>	选项A：<input id="SA" type="text" disabled="disabled"/>&nbsp;&nbsp;选项B：<input id="SB" type="text" disabled="disabled"/></div>	
			<div>	选项C：<input id="SC" type="text" disabled="disabled"/>&nbsp;&nbsp;选项D：<input id="SD" type="text" disabled="disabled"/></div>			
			<div>	答案：<input id="result" type="text" size="1" disabled="disabled"/>&nbsp;&nbsp;难度：<input id="difficulty" type="text" size="2" disabled="disabled"/>&nbsp;&nbsp;创建时间：<input id="createTime" type="text" size="20" disabled="disabled"/></div>	
			<div>	
				<fieldset>
					<legend>分析：</legend>
